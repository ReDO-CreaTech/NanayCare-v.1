  ...
  // ==========================
    ...
    if (action === "edit") {
      ...
      render(card(`
        ...
        <textarea id="note" placeholder="Doctor notes..."></textarea>
    ...
    if (action === "update") {
      ...
      updated.history.push({
        ...
        snapshot: {
          name: updated.name,
          ageDays: updated.ageDays,
          weight: updated.weight,
          unableToDrink: updated.unableToDrink,
          convulsions: updated.convulsions,
          lethargic: updated.lethargic,
          fever: updated.fever,
          lowTemp: updated.lowTemp
        }
      });
    ...
    return `
      <div class="card">
        ...
        <div class="section">
          ...
          <p><strong>Age:</strong> ${s.ageDays || "-"} days</p>
